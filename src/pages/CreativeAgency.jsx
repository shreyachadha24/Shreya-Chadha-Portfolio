      ...
      <main className="pt-24 md:pt-36 pb-16 md:pb-32" style={{ position: 'relative', zIndex: 1 }}>
        <div style={{
          ...
          <p style={{
            ...
            Visual Design · Project Manager
          </p>

          <h1 className="font-bold text-gray-900 leading-tight mb-6"
            style={{ fontSize: 'clamp(2rem, 6vw, 5rem)', letterSpacing: '-0.02em', maxWidth: '14ch' }}>
            The GIT{' '}
            <em style={{ fontFamily: "'Cormorant Garamond', serif", color: pink, fontStyle: 'italic', fontWeight: 400 }}>
              Creative Agency
            </em>
          </h1>
